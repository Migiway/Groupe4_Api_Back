...
/**
 * @ORM\Entity(repositoryClass="App\AdminBundle\Repository\ParameterCompanyCARepository")
 */
class ParameterCompanyCA
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\AdminBundle\Entity\Company", mappedBy="parameterCompanyCA")
     */
    private $company_id;
