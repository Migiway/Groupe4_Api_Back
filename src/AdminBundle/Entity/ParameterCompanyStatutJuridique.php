...
/**
 * @ORM\Entity(repositoryClass="App\AdminBundle\Repository\ParameterCompanyStatutJuridiqueRepository")
 */
class ParameterCompanyStatutJuridique
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\AdminBundle\Entity\Company", mappedBy="parameterCompanyStatutJuridique")
     */
    private $company_id;
